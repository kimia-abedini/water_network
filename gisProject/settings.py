...
SECRET_KEY = 'django-insecure-ggjj$=52u%%#kl-!+1#_a&pn5dk&3&5m9oy7-=)2mtjz=&&9js'
...
# Leaflet configuration if using Leaflet
LEAFLET_CONFIG = {
    'DEFAULT_CENTER': (45.428152125702184, 11.866865158081056),
    'DEFAULT_ZOOM': 16,
    'MIN_ZOOM': 3,
    'MAX_ZOOM': 18,
    'TILES': [
