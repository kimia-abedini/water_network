...
def regularUser(request):
    return render(request,'users/regular.html')
...
def showReports(request):
    ...
    geojson = serialize('geojson', reports, geometry_field='user_coordinate', fields=('report_type', 'description', 'report_date', 'photo', 'user_id'))
